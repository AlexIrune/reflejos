...
Future<FFFirestorePage<ProgramasRecord>> queryProgramasRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
...
/// Functions to query EntrenadoresRecords (as a Stream and as a Future).
Future<int> queryEntrenadoresRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EntrenadoresRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EntrenadoresRecord>> queryEntrenadoresRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<EntrenadoresRecord>> queryEntrenadoresRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<EntrenadoresRecord>> queryEntrenadoresRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
